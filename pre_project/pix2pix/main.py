import argparse     #호출 당시 인자값을 줘서 동작을 다르게함
import os
import scipy.misc
import numpy as np
import sys
...
parser = argparse.ArgumentParser(description='')        #인자값을 받을 수 있는 인스턴스 생성
parser.add_argument('--dataset_name', dest='dataset_name', default='facades', help='name of the dataset')       #add_argument로 입력받을 인자값 등록

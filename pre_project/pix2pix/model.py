...
class pix2pix(object):
    def __init__(self, sess, image_size=256,
        ...
        Args:
            ...
            output_size: (optional) The resolution(해상도) in pixels of the images. [256]
            gf_dim: (optional) Dimension of generator filters in first conv layer. [64]:generator 첫번째 레이어의 차원
            df_dim: (optional) Dimension of discriminator filters in first conv layer. [64]:discriminator 첫번째 레이어의 차원
    ...
    def load_random_samples(self):
        ...
        #glob는 파일들의 목록을 뽑을 때 사용하는데, 파일의 경로명을 이용해서 필요한 데이터를 뽑아냄
    ...
    def generator(self, image, y=None):
        with tf.variable_scope("generator") as scope:
            ...
            #concat 설명: https://lsjsj92.tistory.com/456
    ...
    def load(self, checkpoint_dir):
        ...
        first_smaple='pix2pix.model-67002'
        second_sameple='pix2pix.model-67002'
        third_sample='pix2pix.model-92002'
        fourth_sample='pix2pix.model-53502'
        fifth_sample='pix2pix.model-99502'
        model_dir = "%s_%s_%s" % (self.dataset_name, self.batch_size, self.output_size)
        checkpoint_dir = os.path.join(checkpoint_dir, model_dir)
